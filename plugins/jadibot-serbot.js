...
let drm1 = ""
let drm2 = ""
let rtx = "*「⭐」𝐒𝐓𝐀𝐑𝐋𝐈𝐆𝐇𝐓𝐒「⭐」*\n\n🤖 Cσɳҽxισɳ SυႦ-Bσƚ Mσԃҽ QR\n\n⚠️ Con otro celular o en la PC escanea este QR para convertirte en un *Sub-Bot* Temporal.\n\n\`1\` » Haga clic en los tres puntos en la esquina superior derecha\n\n\`2\` » Toque dispositivos vinculados\n\n\`3\` » Escanee este codigo QR para iniciar sesion con el bot\n\n🔰 ¡Este código QR expira en 45 segundos!."
let rtx2 = "*「⭐」𝐒𝐓𝐀𝐑𝐋𝐈𝐆𝐇𝐓𝐒「⭐」*\n\n🤖 Cσɳҽxισɳ SυႦ-Bσƚ Mσԃҽ Cσԃҽ\n\n⚠️ Usa este Código para convertirte en un *Sub-Bot* Temporal.\n\n\`1\` » Haga clic en los tres puntos en la esquina superior derecha\n\n\`2\` » Toque dispositivos vinculados\n\n\`3\` » Selecciona Vincular con el número de teléfono\n\n\`4\` » Escriba el Código para iniciar sesion con el bot\n\n🔰 No es recomendable usar tu cuenta principal."
...
m?.chat ? await conn.sendMessage(m.chat, {text: args[0] ? `@${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `@${m.sender.split('@')[0]}, Ahora eres parte de nuestra familia de Sub-Bots.`, mentions: [m.sender]}, { quoted: m }) : ''
