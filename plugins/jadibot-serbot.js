...
let handler = async (msg, { conn, args, usedPrefix, command, isOwner }) => {
  if (!global.db.data.settings[conn.user.jid].jadibotmd) {
    return conn.reply(msg.chat, "*Este comando esta deshabilitado por mi creador Brayan.*", msg, global.rcanal); // Changed rcanal to global.rcanal
  }
          ...
          qrMessage = await user.sendMessage(msg.chat, {
            ...
            contextInfo: {
              ...
              forwardedNewsletterMessageInfo: {
                ...
                newsletterName: 'Oficial channel Roxy-MD',
                serverMessageId: -1
              }
            }
          }, { quoted: msg });
